...
namespace Magento\Ccavenuepay\Block\Payflow\Link;

/**
 * Payflow link iframe block
 */
class Iframe extends \Magento\Ccavenuepay\Block\Iframe {
    ...
    \Magento\Framework\View\Element\Template\Context $context, \Magento\Sales\Model\OrderFactory $orderFactory, \Magento\Checkout\Model\Session $checkoutSession, \Magento\Ccavenuepay\Helper\Hss $hssHelper, \Magento\Framework\Filesystem\Directory\ReadFactory $readFactory, \Magento\Framework\Module\Dir\Reader $reader, \Magento\Payment\Helper\Data $paymentData, array $data = []
    ) {
    ...
    protected function _construct() {
        parent::_construct();
        $this->_paymentMethodCode = \Magento\Ccavenuepay\Model\Config::METHOD_CCAVENUEPAYLINK;
    }
