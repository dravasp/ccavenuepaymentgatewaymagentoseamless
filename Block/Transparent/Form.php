...
use Magento\Ccavenuepay\Model\Method\Adapter;
use Magento\Ccavenuepay\Model\Method\TransparentInterface;
 ...
 */
class Form extends \Magento\Ccavenuepay\Block\Form\Ccavenuepay {
     ...
     * @var string
     */
    protected $_template = 'Magento_Ccavenuepay::transparent/form.phtml';
    ...
    Context $context, Config $paymentConfig, Session $checkoutSession, array $data = []
    ) {
