...
use Magento\Ccavenuepay\Model\Response as CcavenuepayResponse;
use Magento\Framework\Encryption\Helper\Security;

/**
 * Authorize.net response model for Ccavenuepay model
 */
class Response extends CcavenuepayResponse {
    ...
    public function isApproved() {
        return $this->getXResponseCode() == \Magento\Ccavenuepay\Model\Ccavenuepay::RESPONSE_CODE_APPROVED;
    }
