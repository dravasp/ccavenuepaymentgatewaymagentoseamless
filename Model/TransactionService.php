 ...
 * @package Magento\Ccavenuepay\Model
 */
class TransactionService {
    ...
    Security $xmlSecurityHelper, Logger $logger, ZendClientFactory $httpClientFactory
    ) {
     ...
     * @param \Magento\Ccavenuepay\Model\Ccavenuepay $context
     * @param string $transactionId
     * @return \Magento\Framework\Simplexml\Element
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function getTransactionDetails(Ccavenuepay $context, $transactionId) {
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    protected function loadTransactionDetails(Ccavenuepay $context, $transactionId) {

        $requestBody = $this->getRequestBody(
                $context->getConfigData('login'), $context->getConfigData('trans_key'), $transactionId
        );
    ...
    private function getRequestBody($login, $transactionKey, $transactionId) {
        $requestBody = sprintf(
                ...
                '<transId>%s</transId>' .
                '</getTransactionDetailsRequest>', $login, $transactionKey, $transactionId
        );
        return $requestBody;
    }
